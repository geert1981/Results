...
function vervang_deel_van_naam(zoekterm_poule_names) {
    for (let i = 0; i < search_poule_names.length; i++) {
        ...
        if (zoekterm_poule_names.includes(search_term_poule_names)) {
            ...
            // return zoekterm_poule_names.replace(RegExp_escape(search_term_poule_names), replacement_poule_names);
