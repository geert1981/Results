...
document.getElementById("Current_year_text").innerHTML += "<h8>&copy; " + current_year + " Designed by Geert Kril - All rights reserved</h8>";

// INFO CLUBS
var bvbl = 'BVBL1156';
var page_style = 'background-color: red; color: white; background-image: linear-gradient(45deg, rgb(255, 0, 0), 70%, rgb(2, 0, 36));';
var team_logo = 'logos/BVBL1156.png';
var bvbl_code;
