...
function show_week(start_date) {
    const date_range_kalender_club = document.getElementById('date_range_kalender_club');
    if (date_range_kalender_club) {
        ...
        if (!isNaN(last_day_of_week.getTime())) {
            ...
            date_range_kalender_club.textContent = week_range;
            document.getElementById('date_range_kalender_club').textContent = week_range;
            document.getElementById('date_range_kalender_reeks').textContent = week_range;
