...
// Toon een popup met het iCal-adres van het team en kopieer het naar het klembord
export function ical() {
    ...
    // Selecteer en kopieer het iCal-adres
    popupInput.select();
    if (navigator.clipboard) {
        navigator.clipboard.writeText(url_ical);
    } else {
